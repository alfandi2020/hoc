		...
		<div class="main_container">
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="<?php echo base_url();?>" class="site_title"><img src="<?php echo base_url();?>img/boc_logo.png"
								alt="..." height="42" width="60"><span> Bangun Desa</span></a>
					</div>
          ...
          ?>
								...
								<div class="item form-group">
									<label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Project
										Name</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<?php if ($this->uri->segment(3) == true) {?>
											<input type="text" class="form-control" value="<?= $task_edit['name'] ?>" name="project_name"
								...
								<hr>
								<div class="item form-group">
									<label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Member
										Project</label>
									<!-- <div class="col-md6 col-sm-6 col-xs-12"> -->
									<?php if (!empty($this->uri->segment(4))){?>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<?php if (!empty($memo->nip_kpd)){?>
										<select class="js-example-basic-multiple" name="member_task[]" id="member_task" multiple="multiple">
										...
										<?php }else{?>
										<select class="js-example-basic-multiple" required="required" name="member_task[]" id="member_task"
											multiple="multiple">
											<?php foreach ($sendto as $data):?>
											<option value="<?php echo $data->nip; ?>"><?php echo $data->nama; ?></option>
											<?php endforeach; ?>
									...
									<?php endforeach; ?>
										...
										<select class="form-control js-example-basic-multiple" required="required" name="member_task[]"
											id="member_task" multiple="multiple">
											<?php 
								...
								<div class="item form-group">
									<label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Activity
										Project</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<?php if ($this->uri->segment(3) == true) {?>
