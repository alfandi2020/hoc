			...
			<div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     <div class="x_panel card">
						...
						<div class="x_content">
                           <br/> 
                        <?php echo form_open_multipart('app/save_task', 'class="form-horizontal form-label-left" name="form_input" id="form_input" enctype="multipart/form-data"');?>
						<!-- <form action="<?= base_url('app/simpan_memo') ?>" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data"> -->
						<div class="item form-group">
                            <label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Project Name</label>
							<div class="col-md6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" name="project_name" required>
                            </div>
						</div>
						<div class="item form-group">
                            <label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Member Project</label>
							<!-- <div class="col-md6 col-sm-6 col-xs-12"> -->
                            <?php if (!empty($this->uri->segment(4))){?>
								<div class="col-md-6 col-sm-6 col-xs-12">
								  <?php if (!empty($memo->nip_kpd)){?>
								  <select class="form-control js-example-basic-multiple" name="member_task[]" id="member_task" multiple="multiple">
								  ...
								  <?php }else{?>
									<select class="form-control js-example-basic-multiple" required="required" name="member_task[]" id="member_task" multiple="multiple">
										<?php foreach ($sendto as $data):?>        
											<option value="<?php echo $data->nip; ?>"><?php echo $data->nama; ?></option> 
										<?php endforeach; ?>
									</select>  
                        ...
                        <div class="item form-group">
                            <label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Activity Project</label>
							<div class="col-md6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<button id="submit-memo" type="submit" class="btn btn-success">Create Task</button><br>
