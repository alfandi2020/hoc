                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     <div class="x_panel card">
						...
						<div class="item form-group">
                            <label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Nomor Surat</label>
							<div class="col-md6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control">
                            </div>
						</div>
						<div class="item form-group">
                            <label style="text-align: left;" class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal</label>
							<div class="col-md6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control">
                            </div>
						</div>
