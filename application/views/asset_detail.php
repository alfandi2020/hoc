  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		<div class="x_panel">
						...
						<div class="x_content">
							...
							<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
								...
								<div class="item form-group">
									<label class="col-form-label col-md-3 col-sm-3 label-align">Update Terakhir <span class="required">*</span>
									</label>
						...
						<div class="x_content">
							...
							<thead>
							  <tr>
								...
								<th bgcolor="#008080"><font color="white">Ruangan</font></th>
								<th bgcolor="#008080"><font color="white">Lokasi</font></th>
								<th bgcolor="#008080"><font color="white">Tanggal</font></th>
								<th bgcolor="#008080"><font color="white">Remarks</font></th>
							  </tr>
							</thead>
							<?php
							$no=1;
        ...
        <!-- /page content -->
	<form data-parsley-validate action="<?php echo base_url();?>app/simpan_update" method="post" name="form_fullpayment" id="form_fullpayment" class="form-horizontal form-label-left">
