  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		<div class="x_panel card">
			...
			<thead>
			  <tr>
				...
				<th bgcolor="#008080"><font color="white">Kode</font></th>
				<th bgcolor="#008080"><font color="white">Nama</font></th>
				<th bgcolor="#008080"><font color="white">Spesifikasi</font></th>
				<th bgcolor="#008080"><font color="white">Ruang</font></th>
				<th bgcolor="#008080"><font color="white">Lokasi</font></th>
				<th bgcolor="#008080"><font color="white">Jns</font></th>
				<th bgcolor="#008080"><font color="white">Jml</font></th>
				<th bgcolor="#008080"><font color="white">Detail</font></th>
			  </tr>
			</thead>
			<?php
        ...
        <!-- /page content -->
		<form data-parsley-validate action="<?php echo base_url();?>app/add_asset" method="post" name="form_fullpayment" id="form_fullpayment" class="form-horizontal form-label-left">
		 ...
		 <div class="modal-dialog">
			...
			<div class="modal-content">
			   ...
			   <div class="modal-body">
				  <h4><font color="Grey"><Strong></h4><br>
